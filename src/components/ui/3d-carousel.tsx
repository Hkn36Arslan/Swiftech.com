      ...
      >
        ...
        >
          {cards.map((imgUrl, i) => (
            <motion.div
              key={`key-${imgUrl}-${i}`}
              className="absolute flex h-full origin-center items-center justify-center bg-gray-950 p-1"
              style={{
                width: `${faceWidth}px`,
            ...
            >
              <motion.img
                ...
                alt=""
                layoutId={`img-${imgUrl}`}
                className="pointer-events-none aspect-square w-full rounded-[var(--radius)] object-cover"
 ...
 * Renk/radius design-system.md'ye (monokrom, 2px radius, lime accent)
      ...
      <AnimatePresence mode="sync">
        {activeImg && (
          <motion.div
            ...
            layout="position"
            onClick={handleClose}
            className="fixed inset-0 z-50 m-5 flex items-center justify-center rounded-[var(--radius)] bg-black/80 md:m-36 lg:mx-[19rem]"
